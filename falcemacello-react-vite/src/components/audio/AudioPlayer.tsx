...
export function AudioPlayer() {
    ...
    return (
        <div className="w-full bg-brand-dark/80 backdrop-blur-md border border-brand-red/20 rounded-lg p-6 shadow-[0_0_30px_rgba(204,0,0,0.2)]" role="region" aria-label="Audio Player">
